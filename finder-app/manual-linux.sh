...
LIBC=/home/jeevank12/Downloads/Linux_gcc_cross_compiler/gcc-arm-10.3-2021.07-x86_64-aarch64-none-linux-gnu/aarch64-none-linux-gnu/libc
...
#make ${CROSS_COMPILE}readelf -a bin/busybox | grep "program interpreter"
#make ${CROSS_COMPILE}readelf -a bin/busybox | grep "Shared library"
